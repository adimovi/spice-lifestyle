...
export default function Bbq() {
       ...
       <div className="container py-5">
        <div className="row d-flex  justify-content-center ">
          <div className="col-lg-10 col-12 p-lg-4 p-2 bg-white rounded-3 shadow">
           <p>It’s always nice to try new culinary experiences as you travel the world, BUT it's also nice to find a place to eat that you recognise and know what to expect.</p>
           <p>As of now, the only brands that exist everywhere are the fast food chains, we are all familiar with, BUT you don’t want to be eating too much of that food for obvious reasons.</p>
           <p className='mb-0'>There is no point in trying to create a global chain of high end dining restaurants for many reasons, BUT suppose you created a quality healthy and very tasty eating option that would transcend all cultures, where the customer would pay between $15 & $25.</p>
          </div>
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">Open 10 proof of concept outlets</th>
      <td>2,500,000</td>
    </tr>
