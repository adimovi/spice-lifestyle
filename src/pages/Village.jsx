...
function Village() {
  return (
    <>
        <h1 className='text-center bold pt-5'>Spice CoLiving Villages</h1>
      ...
      <div className="row d-flex justify-content-center">
        <div className="col-lg-10 col-12">
          ...
          <table className="table mb-5  table-bordered bbq">
  <thead>
    <tr>
      <th scope="col" style={{width:"70%"}}>Expected Investment Required</th>
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">HQ Team costs for three years</th>
      <td>3,000,000</td>
    </tr>
    <tr>
      <th scope="row">One proof of concept village cost</th>
      <td>13,000,000</td>
    </tr>
...
<table className="table  table-bordered bbq">
  <thead>
    <tr>
      <th scope="col" style={{width:"70%"}}>Total Expected annual rental Income</th>
      <th scope="col" style={{width:"30%"}}></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <th scope="row">200 units</th>
      <td>200</td>
    </tr>
    <tr>
      <th scope="row">800 x 12 months rental income</th>
      <td>9,600</td>
    </tr>
    <tr>
      <th scope="row">Total annual Income for one village</th>
      <td>1,920,000</td>
    </tr>
    
    <tr>
      <th scope="row">Years ROI</th>
      <td>8</td>
    </tr>
  </tbody>
</table>
