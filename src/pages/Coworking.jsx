  ...
  return (
    ...
    <div className="container py-5">
      <div className="row d-flex justify-content-center">
        <div className="col-lg-10 p-lg-4 p-3 col-12 bg-white rounded-3 shadow">
...
<table className="table table-bordered bbq">
  <thead>
    <tr>
      <th scope="col" style={{width:"65%"}}>Expected Income</th>
      <th scope="col" style={{width:"35%"}}></th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td>54,000,000</td>
        ...
        <div className="col-lg-5 col-12 align-self-center">
          <img src="imgs/cowplan.jpg" alt="coworking plan" className='d-block mx-auto rounded-3' style={{width:"100%"}}/>
        </div>
        </div>
      </div>
    </div>
